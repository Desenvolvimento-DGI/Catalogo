...
//
		...
		echo "$sql <br>";
			...
			echo ("<h3><center><p>Done! You can request satellite images.</p>
...
<table border="0">
    <th colspan="2" class="style6">Register</th>
...
<td class="FUNDOResp"><input name="userId"  tabindex="2"value="<?=$userId?>" ><font color="#CCCCCC">* Write a single word without accent or symbols.</font></td></tr>
<tr><td class="FUNDOResp"><span class="style16">
  <?=$strPass?>
</span></td>

...
function decodeGralha2($filename,&$satellite,&$number,&$instrument,&$channel,&$type,&$date,&$path,&$row,&$hora,&$quadrante, &$areaorbita, &$areaponto)
{
	if ($GLOBALS["stationDebug"])
		echo "decodeGralha - filename = $filename <br>\n";
	$fname=str_replace(".","_",$filename);
...
/*  if(substr($result[0],0,5)=="CREFL")
   ...
   $type="";
	...
	if (  ( strtoupper($satellite) == "UKDMC"  or strtoupper($satellite) == "UKDMC2"  or strtoupper($satellite) == "UK-DMC2" ) and strtoupper($instrument) == "SLIM" )
	{
	...
	if (  ( strtoupper($satellite) == "RS2"  or strtoupper($satellite) == "RES2"  or strtoupper($satellite) == "RESOURCESAT2" ) and ( strtoupper($instrument) == "LIS3"  or strtoupper($instrument) == "AWIF" ) )
	{
	...
	if (  ( strtoupper($satellite) == "L8"  or strtoupper($satellite) == "LANDSAT8"  or strtoupper($satellite) == "LANDSAT-8" ) and ( strtoupper($instrument) == "OLI" ) )
	{
	...
	// CBERS-4
	if (  strtoupper($satellite) == "CB4"  or strtoupper($satellite) == "CB04"  or strtoupper($satellite) == "CBERS4"  or strtoupper($satellite) == "CBERS-4" )
	{		
		$satellite=$result[0];
		$number=$result[1];
		$instrument=$result[2];
	...
	// CBERS2 Reprocessado	
	if (  ( strtoupper($satellite) == "CB2"  or strtoupper($satellite) == "CBERS2"  or strtoupper($satellite) == "CBERS-2" ) and ( strtoupper($instrument) == "CCD"  or strtoupper($instrument) == "IRM" or strtoupper($instrument) == "WFI")  and (strlen() == 27 ) )
	{
	...
	if (  ( strtoupper($satellite) == "RE1"  or strtoupper($satellite) == "RE2"  or strtoupper($satellite) == "RE3"  or strtoupper($satellite) == "RE4"  or strtoupper($satellite) == "RE5" ) and strtoupper($instrument) == "REIS" )
	{

...
*/   
 ...
 //  Imagem NOAA19
  ...
  var coordenadasNOAA19 = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-46.3901777, -59.1051408 ),
	  new google.maps.LatLng(3.9514106, -22.7143888) );


  var localizacaoNOAA19 = 'http://www.dgi.inpe.br/catalogo/QL_NOAA_19_HRPT_2014_12_31.16_49_29_CP1_crop.PNG';				    
			  
  var imagemNOAA19 = new google.maps.GroundOverlay(localizacaoNOAA19, coordenadasNOAA19); 
  
  
  
		google.maps.event.addListener(imagemNOAA19,'mouseover',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemNOAA19 != null ) 
			{
				imagemNOAA19.setOpacity(0.40);
			}
		...
		google.maps.event.addListener(imagemNOAA19,'mouseout',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemNOAA19 != null ) 
			{
				imagemNOAA19.setOpacity(1);
			}

...
$strWhere=" WHERE ( Desativado = 'N' AND Satellite = 'L8' AND Sensor = 'OLI'  AND Date >= '2015-08-20' AND Date <= '2015-08-30' )";
...
{	
	...
	$kml[] = '		<drawOrder>0</drawOrder>';
	$kml[] = '		<Icon>';
	$kml[] = '			<href>http://www.dgi.inpe.br/QUICKLOOK/LANDSAT8/OLI//QL_' . $sceneId . '_GRD.png</href>';

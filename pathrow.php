...
//$SENSOR = $_GET['sensor'];
$ORBITAI = $_GET['start_path'];
$ORBITAF = $_GET['end_path'];
$PONTOI = $_GET['start_row'];
$PONTOF = $_GET['end_row'];
...
#
# End Checking Satellite and Sensor
#
...
if(isset($ORBITAI))
{
   ...
   if(trim($result[0]) != trim($ORBITAI)) $invalid_path = 1; // die ("<br><h3> Invalid Path : $ORBITAI</h3><br>");
   else ;
  else $invalid_path = 1;    //die ("<br><h3> Invalid Path : $ORBITAI</h3><br>");
...
if(isset($ORBITAF))
{
   ...
   if(trim($result[0]) != trim($ORBITAF)) $invalid_path = 1; // die ("<br><h3> Invalid Path : $ORBITAF</h3><br>");
   else ;
  else $invalid_path = 1; //die ("<br><h3> Invalid Path : $ORBITAF</h3><br>");
...
if(isset($PONTOI))
{
   ...
   if(trim($result[0]) != trim($PONTOI)) $invalid_path = 1; // die ("<br><h3> Invalid Row : $PONTOI</h3><br>");
   else ;
  else $invalid_path = 1;  // die ("<br><h3> Invalid Row : $PONTOI</h3><br>");
  $PONTOI = trim($PONTOI);
} else $invalid_path = 1;
...
if(isset($PONTOF))
{
   ...
   if(trim($result[0]) != trim($PONTOF)) $invalid_path = 1; // die ("<br><h3> Invalid Row : $PONTOF</h3><br>");
   else ;
  else $invalid_path = 1;  // die ("<br><h3> Invalid Row : $PONTOF</h3><br>");
  $PONTOF = trim($PONTOF);
} else $invalid_path = 1;   
#
...
if ($invalid_path != 1 and $no_satellite != 1 and $catid == "INPE")
{

...
/*  if(substr($result[0],0,5)=="CREFL")
   ...
   $type="";
	...
	// Incluído por José Renato
	// Inicio
	$aux_satelite=strtoupper(substr($satellite,0,2));
	if ( $aux_satelite == "A1" || $aux_satelite == "T1" )
	{
		echo "<br>*** Satelite AQUA ou TERRA - satellite = $satellite  e aux_satelite = $aux_satelite<br>\n";		
	}

...
var	centroMapa = new google.maps.LatLng(-2.8976287, -42.0067541);
...
*/   
  ...
  */
  ...
  /*
  var coordenadasCBERS = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-17.5929928, -42.0650192),
	  new google.maps.LatLng(-16.4319825, -40.7579374) );
  */
 ...
 /*
  ...
  var localizacaoCBERS = 'http://www.dgi.inpe.br/catalogo/QL_CBERS_2_CCD1XS_20081219_150_119_L2_GEO_40.png';				    
			  
  var imagemCBERS = new google.maps.GroundOverlay(localizacaoCBERS, coordenadasCBERS); 
  
  
  
		google.maps.event.addListener(imagemCBERS,'mouseover',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemCBERS != null ) 
			{
				imagemCBERS.setOpacity(0.40);
			}
		...
		google.maps.event.addListener(imagemCBERS,'mouseout',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemCBERS != null ) 
			{
				imagemCBERS.setOpacity(1);
			}
  ...
  imagemCBERS.setMap(map);	
  
  */

/*  
Upper Left  ( -47.6262177, -22.0536917) ( 47d37'34.38"W, 22d 3'13.29"S)
Lower Left  ( -47.6262177, -24.1687162) ( 47d37'34.38"W, 24d10' 7.38"S)
Upper Right ( -45.3706048, -22.0536917) ( 45d22'14.18"W, 22d 3'13.29"S)
Lower Right ( -45.3706048, -24.1687162) ( 45d22'14.18"W, 24d10' 7.38"S)

	  new google.maps.LatLng(-47.6262177, -24.1687162 ),
	  new google.maps.LatLng(-45.3706048, -22.0536917) );
	  
  var coordenadasL8 = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-46.3901777, -59.1051408 ),
	  new google.maps.LatLng(3.9514106, -22.7143888) );
...
*/  
 ...
 //  Imagem NOAA19
  ...
  var coordenadasL8 = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-24.1687162, -47.6262177),
	  new google.maps.LatLng(-22.0536917, -45.3706048) );


  var localizacaoL8 = 'http://www.dgi.inpe.br/catalogo/LO82190762015074CUB00_GEO_40_POR_CENTO.PNG';				    
			  
  var imagemL8 = new google.maps.GroundOverlay(localizacaoL8, coordenadasL8); 
  
  
  
		google.maps.event.addListener(imagemL8,'mouseover',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemL8 != null ) 
			{
				imagemL8.setOpacity(0.40);
			}
		...
		google.maps.event.addListener(imagemL8,'mouseout',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemL8 != null ) 
			{
				imagemL8.setOpacity(1);
			}
		...
		fpNOAA19 = new google.maps.Data();
		
		
		fpNOAA19.loadGeoJson( 'http://www.dgi.inpe.br/catalogo/NOAA_19_HRPT_2014_12_31.16_49_29_CP1_footprint.geojson' );
		fpNOAA19.setStyle({ strokeColor: 'red', strokeWeight: 0.7, fillColor: 'white', fillOpacity: 0.1, clickable: false});		
		fpNOAA19.setMap(map);
...
Upper Left  ( -43.0355630,  -1.8405722) ( 43d 2' 8.03"W,  1d50'26.06"S)
Lower Left  ( ,  ) ( 43d 2' 8.03"W,  3d57'16.87"S)
Upper Right ( ,  ) ( 40d58'40.60"W,  1d50'26.06"S)
Lower Right ( -40.9779453,  -3.9546852) ( 40d58'40.60"W,  3d57'16.87"S)

		
		*/
  

  var coordenadasL8b = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-3.9546852, -43.0355630),
	  new google.maps.LatLng(-1.8405722, -40.9779453) );


  var localizacaoL8b = 'http://www.dgi.inpe.br/catalogo/LO82190622015074CUB00_GEO_40_POR_CENTO.PNG';				    
			  
  var imagemL8b = new google.maps.GroundOverlay(localizacaoL8b, coordenadasL8b); 
  
  
  
		google.maps.event.addListener(imagemL8b,'mouseover',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemL8b != null ) 
			{
				imagemL8b.setOpacity(0.35);
			}
		...
		google.maps.event.addListener(imagemL8b,'mouseout',function() 
		{ 			
			//infoWindowImagens.close(map, arrayImgOverlay[indice]);
			if ( imagemL8b != null ) 
			{
				imagemL8b.setOpacity(1);
			}
        ...
        imagemL8b.setMap(map);	
  	
	  
  
  
		gradeLandSat = new google.maps.KmlLayer({
			      url: 'http://www.dgi.inpe.br/catalogo/kml/kml_CBERS4_MUX_Versao_02.kml',
			      preserveViewport: true
			      });
...
function footPrint( parametroFootPrint )
{
	...
	var classIconStatus='icon-sign-blank';
...
function imgOverlay( parametroImgOverlay, centralizaImagem, aplicaZoomImagem)
{
	...
	if ( arrayImgOverlay[indice] == null )
	{
		...
		var localizacaoImagem = diretorioQuickLook +  dirSateliteAtual + '/' +
		                        parametroImgOverlay[3].toUpperCase() + '/QL_' + parametroImgOverlay[1] + 
								'_GRD.png';

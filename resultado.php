...
<head>
    ...
    <title>Divisão de Geração de Imagem :: Catálogo de Imagens :: Resultados</title>
    ...
    <link href="/catalogo/css/blink.css" rel="stylesheet">
    ...
    <script src="/catalogo/resultado.js"></script>

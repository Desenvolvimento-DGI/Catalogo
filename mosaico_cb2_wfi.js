...
var	centroMapa = new google.maps.LatLng(-21.3955295, -45.9274637);
...
*/  
  ...
  var coordenadasL8 = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-26.3359904, -51.8307817),
	  new google.maps.LatLng(-16.4550685, -40.0241458) );



  var localizacaoL8 = 'http://www2.dgi.inpe.br/catalogo/WARP_CBERS_2_WFI_20050413_154_124_FULL_8BITS.png';				    
  ...
  var imagemL8 = new google.maps.GroundOverlay(localizacaoL8, coordenadasL8); 
		...
		var coordenadasFP = [ 
			new google.maps.LatLng(-16.926852, -49.617574),
			new google.maps.LatLng(-18.256758, -40.729603),
			new google.maps.LatLng(-25.958112, -42.328188),
			new google.maps.LatLng(-24.553699, -51.715497),
			new google.maps.LatLng(-16.926852, -49.617574) ];	
	
		var fpPoligono = new google.maps.Polyline({
			path: coordenadasFP,
			strokeColor: '#FF0000',
			strokeWeight: 1});	
		
		fpPoligono.setMap(map);		

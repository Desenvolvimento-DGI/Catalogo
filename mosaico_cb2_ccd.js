...
var	centroMapa = new google.maps.LatLng(-2.6879972, -58.3962881);
...
function initialize() 
{
  ...
  */
  ...
  var coordenadasL8 = new  google.maps.LatLngBounds(
	  new google.maps.LatLng(-3.2636735, -59.0079442),
	  new google.maps.LatLng(-2.1123209, -57.7846320) );



  var localizacaoL8 = 'http://www2.dgi.inpe.br/catalogo/WARP_CBERS_2_CCD1XS_20090106_171_103_FULL_8BITS_20PCT.png';				    
  ...
  var imagemL8 = new google.maps.GroundOverlay(localizacaoL8, coordenadasL8); 
		...
		var coordenadasFP = [ 
			new google.maps.LatLng(-2.112647, -58.791050),
			new google.maps.LatLng(-2.260522, -57.784874),
			new google.maps.LatLng(-3.263508, -58.000462),
			new google.maps.LatLng(-3.115484, -59.007657),
			new google.maps.LatLng(-2.112647, -58.791050) ];	

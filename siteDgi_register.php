...
//
		...
		echo "$sql <br>";
			...
			echo ("<h3><center><p>Pronto! Voc&ecirc; ja pode pedir imagens de Sat&eacute;lites </p>
<p>volte a Pagina inicial </p></center></h3>"); 
		...
		else
		{
			...
			else echo "<h3> Usuário $strMess3 <h3>";
		}
	}
...
<form method="post" action="siteDgi_register.php">
<table border="0">
<?
	if($lang == "EN"){
		echo "  <th colspan='2' class='style6'>Register</th>";

	} else{
		echo "  <th colspan='2' class='style6'>Cadastrar</th>";
...
<tr ><td class="FUNDOResp"><span class="style16">E-mail</span></td>
...
<option value="Educação Básica"><?=$strBasicEduc?></option>
<option value="Educação Superior"><?=$strHigherEduc?></option>
<option value="P&oacute;s Gradua&ccedil;&atilde;o"><?=$strGradEduc?></option>
...
<option value="Educa&ccedil;&atilde;o"><?=$strEducation?></option>
...
<option value="Sa&uacute;de"><?=$strHealth?></option>
